package kdt.prgrms.gccoffee.repository;
...
class ProductJdbcRepositoryTest {
    ...
    void testInsert(){
        ...
        assertThat(allProduct.isEmpty(), is(false));
    }

    @Test
    @Order(2)
    @DisplayName("상품을 이름으로 조회활 수 있다.")
    void testFindByName(){
    ...
    @Test
    @Order(4)
    @DisplayName("상품들을 카테고리로 조회활 수 있다.")
    ...
    void testDeleteAll(){
        ...
        List<Product> allProduct = repository.findAll();
        assertThat(allProduct.isEmpty(), is(true));
    }
}